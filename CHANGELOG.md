...
### Added
- A setting under AI integration controls how many comments another plugin may add at once before you are asked. Ten by default. At 1 you are asked whenever a plugin adds more than one comment; a single comment is never confirmed.
