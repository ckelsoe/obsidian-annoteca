...
### Added
- A setting under AI integration controls how many comments another plugin may add at once before you are asked. Ten by default; set it to 1 to be asked every time.
